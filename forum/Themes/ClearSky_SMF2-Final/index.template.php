...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	...
	<div class="rightbox">
	  <div class="leftbox">
		<div id="upper_section" class="middletext"', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>
			<div class="user', $context['right_to_left'] ? ' abs': ' r_abs','">';
	...
	if ($context['user']['is_logged'])
	{
		echo '
				<ul class="reset">
					...
					<li><a href="', $scripturl, '?action=unread">',$txt['newtopics'],'</a></li>
	...
	elseif (!empty($context['show_login_bar']))
	{
		echo '
				...
				<form id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
					<input type="text" value="', $txt['username'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['username'], '\';" name="user" size="10" class="input_text" />
	...
	echo '
			...
			<div class="normaltext', $context['right_to_left'] ? ' s_abs': ' sr_abs','">
	...
	// Show the menu here, ith dropdown menu.
	template_drop_menu();
	...
	<a class="foo_link" href="#">',$txt['gotop'],'</a>
	 ...
	 <div class="inn_footer">
		<ul class="reset">
			...
			<li class="copyright">Clear Sky by <a href="http://www.skinmod.eu">Skinmod.</a></li>
		</ul>';
